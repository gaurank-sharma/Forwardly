...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* heading block */}
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-1 flex-col items-stretch justify-center px-6 pt-32 text-center">
        <span className="hero-eyebrow mb-7 inline-flex max-w-full flex-wrap items-center justify-center gap-2 self-center rounded-full border border-white/15 bg-white/5 px-3.5 py-2 text-center text-[0.6rem] font-semibold uppercase tracking-[0.14em] text-white/70 backdrop-blur sm:px-4 sm:text-xs sm:tracking-[0.18em]">
          <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-[#c2f54b]" />
          Creative &amp; 3D Agency · Web × CGI
        </span>

        <h1 className="w-full min-w-0 font-display text-[clamp(2.5rem,8.5vw,7rem)] font-extrabold leading-[1.02] tracking-[-0.03em] [perspective:800px]">
        ...
        <p className="hero-sub mx-auto mt-7 min-w-0 max-w-xl text-lg leading-relaxed text-white/60">
          We design and build premium digital experiences — high-performance
          websites, photoreal 3D product visuals, brand and growth.
        </p>

        <div className="mt-9 flex flex-col items-center justify-center gap-3 self-center sm:flex-row">
